...
<div class="search-result">
	<?php echo $this->Paginator->counter(array('format' => '<strong>' . implode(' ', $query) . '</strong>'.__('baser',' で検索した結果').' <strong>%start%〜%end%</strong>'.__('baser','件目').' / %count% '.__('baser','件'))) ?>
</div>
<?php endif ?>
...
<?php else: ?>
<div>
	<p class="no-data"><?php echo __('baser', '該当する結果が存在しませんでした。'); ?></p>
</div>
<?php endif ?>
